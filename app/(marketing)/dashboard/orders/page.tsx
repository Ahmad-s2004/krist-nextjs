...
const MOCK_ORDERS = [
  { id: "KRST-842910", date: "June 12, 2026", itemsCount: 2, total: 3030, status: "Processing" },
  { id: "KRST-519284", date: "May 28, 2026", itemsCount: 1, total: 580, status: "Delivered" },
  { id: "KRST-103957", date: "April 15, 2026", itemsCount: 3, total: 5150, status: "Cancelled" },
];
    ...
    <div className="space-y-6">
      <div className="border-b border-neutral-100 pb-4">
        ...
        <p className="text-xs text-gray-400 font-medium tracking-wide pt-0.5">
          Manage and monitor all active fullfillment cycles.
        </p>
      </div>
          ...
          <tbody className="text-xs font-medium text-neutral-700 divide-y divide-neutral-50 tracking-wide">
            {MOCK_ORDERS.map((order) => (
              <tr key={order.id} className="hover:bg-neutral-50/50 transition-colors">
                ...
                <td className="px-6 py-4 text-neutral-500">{order.itemsCount} Items</td>
                <td className="px-6 py-4 font-bold text-black">Rs. {order.total}</td>
