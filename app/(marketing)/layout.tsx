    ...
    <html lang="en" className={`${geistSans.variable} ${geistMono.variable} h-full antialiased`}>
      <body className="min-h-full flex flex-col bg-white text-gray-800">
        ...
        <div className="relative w-full font-sans">
          <nav className="relative w-full border-b border-gray-100 bg-white px-4 py-4 md:px-8 h-[73px] flex items-center">
              ...
              {!isSearchOpen ? (
                <>
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-2xl font-bold tracking-wide text-black cursor-pointer select-none">Krist</span>
                  </div>

                  <div className="hidden gap-6 text-md font-medium text-gray-600 md:flex">
                ...
                <div className="w-full flex items-center gap-4 transition-all duration-300">
                  <div className="relative flex-grow max-w-3xl mx-auto flex items-center bg-gray-50 border border-gray-200 rounded-lg px-3 py-1.5 focus-within:border-gray-400 transition-all duration-200">
                  ...
                  <button 
                    ...
                    className="p-1.5 text-gray-500 hover:text-black hover:bg-gray-100 rounded-full transition-all duration-200 flex-shrink-0"
                    title="Close Search"
                  >
